    ...
    <footer className="bg-black text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <SectionLabel className="text-gray-400">Contact</SectionLabel>
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mt-6 mb-8 leading-tight">
                ...
                {socialLinks.map((social) => (
                  <li key={social.name}>
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-lg hover:text-gray-400 transition-colors group"
                    >
                      {social.name}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} Kavi Prasath. All rights reserved.
          </p>
